...
public class BoxFactory
{
     ...
     */
    private Node createPseudoElement(ElementBox box, PseudoDeclaration pseudo)
    {
    ...
    /**
     * Creates a new instance of the {@link DocumentSource} class registered in the browser configuration
     * ({@link BrowserConfig}).
    ...
    /**
     * Creates a new instance of the {@link DOMSource} class registered in the browser configuration
     * ({@link BrowserConfig}).
