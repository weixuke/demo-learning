...
public class HtmlToImgUtil {
            ...
            try {
                ...
                while ((tmp = br.readLine()) != null) {
                    if (HTML_TO_IMG_FAIL.equals(tmp)) {
                        System.out.println(HTML_TO_IMG_FAIL);
                        return tmp;
                    }
                    if (HTML_TO_IMG_SUCCESS.equals(tmp)) {
                        System.out.println(HTML_TO_IMG_SUCCESS);
                        return tmp;
                    }
                }
            } catch (IOException e) {
    ...
    public static String createParams(String url, String imagePath, int viewWidth, int viewHeight, int waitTime) {
        ...
        //js文件位置
        sb.append("D:\\work_note\\htmlToImg\\demo_phantomjs\\createImageByHtml.js ").append(" ");
        //html URL
        sb.append("{'url':'" + url + "',");
        //图片保存位置
    ...
    public static void main(String[] args) {
        ...
        String imagePath = "D:/temp/util001.png";
        int viewWidth = 2479;
        int viewHeight = 3508;
        int waitTime = 1;
