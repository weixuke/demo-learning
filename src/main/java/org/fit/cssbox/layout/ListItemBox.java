...
public class ListItemBox extends BlockBox
{
    ...
    /** List style type */
    private ListStyleType styleType;
    ...
    {
        return styleType != ListStyleType.NONE;
    }
    ...
    {
        String text;
        if (styleType == ListStyleType.UPPER_ALPHA)
            text = "" + ((char) (64 + (itemNumber % 24)));
        else if (styleType == ListStyleType.LOWER_ALPHA)
            text = "" + ((char) (96 + (itemNumber % 24)));
        else if (styleType == ListStyleType.UPPER_ROMAN)
            text = "" + binaryToRoman(itemNumber);
        else if (styleType == ListStyleType.LOWER_ROMAN)
    ...
    protected void drawBullet(Graphics2D g)
    {
    	...
    	if (styleType == ListStyleType.CIRCLE)
    		g.drawOval(x, y, r, r);
    	else if (styleType == ListStyleType.SQUARE)
    		g.fillRect(x, y, r, r);
    	//else if (type == CSSProperty.ListStyleType.BOX) //not documented, recognized by Konqueror 
    	//	g.drawRect(x, y, r, r);
    	else if (styleType == ListStyleType.DISC)
    		g.fillOval(x, y, r, r);
    	else if (styleType != ListStyleType.NONE)
