...
public class VisualContext 
{
    ...
    public VisualContext(VisualContext parent, BoxFactory factory)
    {
        ...
        textDecoration = new ArrayList<TextDecoration>(2); //it is not very probable to have more than two decorations
        color = Color.BLACK;
    }
    ...
    public VisualContext create()
    {
        ...
        ret.textDecoration = new ArrayList<TextDecoration>(textDecoration);
        ret.color = color;
        return ret;
    }
    ...
    public String getTextDecorationString()
    {
        ...
        else
        {
            ...
            for (TextDecoration dec : textDecoration)
            {
                if (ret.length() > 0)
                    ret.append(' ');
    ...
    public void update(NodeData style)
    {
        ...
        TextDecoration decor = style.getProperty("text-decoration");
        ...
        if (decor != null)
        {
            if (decor == TextDecoration.list_values)
            {
                ...
                for (Term<?> t : list)
                {
                    if (t.getValue() instanceof TextDecoration)
                        textDecoration.add((TextDecoration) t.getValue());
                }
            }
    ...
    public String getFontName(TermList list)
    {
        ...
        for (Term<?> term : list)
        {
            ...
            if (value instanceof FontFamily)
                return ((FontFamily) value).getAWTValue();
            else
            {
